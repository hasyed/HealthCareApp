...
import com.v.mypersonaltrainer.MealActivity2;
	 ...
	 private BaseLoaderCallback  mLoaderCallback = new BaseLoaderCallback(this) {
	        ...
	        public void onManagerConnected(int status) {
	            switch (status) {
	                ...
	                {
	                    Log.i("testing", "OpenCV loaded successfully");
...
*/	                } break;
  ...
  public void onCreate(Bundle icicle) {
    ...
    ocr=(Button)findViewById(R.id.ocrButtonNew);
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    //Imgproc.threshold(mRgba, mRgba, 50, 255, Imgproc.ADAPTIVE_THRESH_MEAN_C); //good quality when near
    ...
    Utils.matToBitmap(mRgba, lastBitmap);
...
*/
    ...
    final String ocrText=ocrResult.getText();
    ocr.setOnClickListener(new OnClickListener() {
		
		@Override
		public void onClick(View arg0) {
			// TODO Auto-generated method stub
			Intent intent= new Intent(getApplicationContext(), MealActivity2.class);
			
			intent.putExtra("str", ocrText);
			startActivity(intent);
		}
	});
